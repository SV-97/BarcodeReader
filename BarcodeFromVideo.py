...
parser.add_argument("-da", "--disable_abort", dest="disable_abort", action="store_true", help="Disable closing the videofeed with esc or lmb (WARNING: Has to be killed if no code is found) (default: abort by key/button)")
parser.add_argument("-m", "--mirror", dest="mirror", action="store_true", help="Invert the video feed along y-axis")
